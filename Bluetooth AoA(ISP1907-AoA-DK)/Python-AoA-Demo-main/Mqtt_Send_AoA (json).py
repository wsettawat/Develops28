...
def publish(client):
    ...
    while True:
        time.sleep(1)
        print("x1={x1}, y1= {y1} ,  z1= {z1}".format(x1 = x1, y1 = y1 , z1= z1))
       
        
        msg={"Address":32770, "PosX":x1, "PosY":y1, "PosZ":z1, "RFID":123456789, "Batt":100, "PanId":17487}
...
def compute_position(tag):
    if tag[AZIMUTH_INDEX] != INVALID_VAL and tag[ELEVATION_INDEX] != INVALID_VAL:
        ...
        global x1, y1, z1
        a=math.cos(-(math.pi*0.316))
        b=math.sin(-(math.pi*0.316))
        A = [[a,b],
            [-b,a]]
        B = [[x*100],
             [y*100]]
